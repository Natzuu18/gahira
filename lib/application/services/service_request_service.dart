    ...
    return pinValid.fold(
      ...
      (isValid) async {
        ...
        final model = ServiceRequestModel(
          ...
          materialDetails: MaterialDetails(type: materialType, weight: materialWeight),
          processingDetails: ProcessingDetails(requirements: processingRequirements, assignedOperatorIds: []),
